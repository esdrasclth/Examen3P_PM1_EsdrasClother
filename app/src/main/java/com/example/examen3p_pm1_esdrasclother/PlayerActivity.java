...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(PlayerActivity.this, descripcion, Toast.LENGTH_SHORT).show();
        ...
        storageReference.getDownloadUrl()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        Toast.makeText(PlayerActivity.this, "Error al descargar el archivo de audio", Toast.LENGTH_SHORT).show();
                    }
                });
    }
        ...
        storageReference.getDownloadUrl()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(PlayerActivity.this, "Error al cargar la imagen", Toast.LENGTH_SHORT).show();
                    }
                });
    }
