...
public class UploadInterviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_interview);db = FirebaseFirestore.getInstance();
    ...
    private void uploadFileToStorage(StorageReference fileReference, Uri fileUri) {
        ...
        fileReference.putFile(fileUri)
                .addOnSuccessListener(taskSnapshot -> {
                    ...
                    Toast.makeText(UploadInterviewActivity.this, "Archivo almacenado con éxito", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(UploadInterviewActivity.this, MainActivity.class);

                    startActivity(intent);
                })
                .addOnFailureListener(e -> {
                    progressDialog.dismiss();
                    Toast.makeText(UploadInterviewActivity.this, "Error al almacenar el archivo: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
        ...
        db.collection("info")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Intent intent = new Intent(UploadInterviewActivity.this, InterviewInformationActivity.class);
