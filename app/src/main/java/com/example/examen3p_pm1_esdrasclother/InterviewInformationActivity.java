...
public class InterviewInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interview_information);
        ...
        btnver = findViewById(R.id.btnReproducir);
        ...
        btnver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(InterviewInformationActivity.this, PlayerActivity.class);
    ...
    private void modificarInfo() {
        ...
        if (idPeriodista != null && !idPeriodista.isEmpty()) {
            ...
            db.collection("info")
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(InterviewInformationActivity.this, "Error al actualizar los datos", Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
            ...
            Toast.makeText(InterviewInformationActivity.this, "No se ha encontrado un ID de periodista", Toast.LENGTH_SHORT).show();
        }
    }

    private void eliminarPeriodistaPorId() {
        ...
        db.collection("info").document(periodistaId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(InterviewInformationActivity.this, "Periodista eliminado con éxito en Firestore", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(InterviewInformationActivity.this, MainActivity.class);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(InterviewInformationActivity.this, "Error al eliminar el periodista en Firestore", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void eliminarArchivoEnStorage(String descripcion) {
        ...
        archivoReference.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(InterviewInformationActivity.this, "Archivo eliminado con éxito en Storage", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(InterviewInformationActivity.this, "Error al eliminar el archivo en Storage", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void buscarIdPeriodistaPorDescripcion() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (task.getResult().isEmpty()) {
                                Toast.makeText(InterviewInformationActivity.this, "No se encontró ningún periodista con esa descripción", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Perfil_entrevista", "Error al buscar el ID del periodista por descripción", task.getException());
                            Toast.makeText(InterviewInformationActivity.this, "Error al buscar el ID del periodista por descripción", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

    private void cargarImagenDesdeFirebaseStorage() {
        ...
        storageReference.getDownloadUrl()
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(InterviewInformationActivity.this, "Error al cargar la imagen", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void cargarImagenConGlide(Uri uri) {
        // Utilizar la biblioteca Glide para cargar la imagen en el ImageView
        Glide.with(InterviewInformationActivity.this)
                .load(uri)
                .into(imageView2);
    }

    private void obtenerYMostrarDescripcionPeriodista() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                Toast.makeText(InterviewInformationActivity.this, "Periodista no encontrado", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Log.e("Perfil_entrevista", "Error al obtener la descripción del periodista", task.getException());
                            Toast.makeText(InterviewInformationActivity.this, "Error al obtener la descripción del periodista", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
